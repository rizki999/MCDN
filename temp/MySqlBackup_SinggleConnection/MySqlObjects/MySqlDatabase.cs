...
namespace MySql.Data.MySqlClient
{
    public class MySqlDatabase : IDisposable
    {
        ...
        {
            _name = _name.Equals(string.Empty) ? QueryExpress.ExecuteScalarStr(cmd, "SELECT DATABASE();") : _name;
            ...
            _listTable = new MySqlTableList(cmd, _name);
            _listProcedure = new MySqlProcedureList(cmd, _name);
            _listFunction = new MySqlFunctionList(cmd, _name);
            _listTrigger = new MySqlTriggerList(cmd, _name);
            _listEvent = new MySqlEventList(cmd, _name);
            _listView = new MySqlViewList(cmd, _name);
