...
namespace MySql.Data.MySqlClient
{
    public class MySqlTable : IDisposable
    {
        ...
        public MySqlTable(MySqlCommand cmd, string tableName, string dbName)
        {
            _name = tableName;
            string sql = string.Format("SHOW CREATE TABLE `{0}`;", dbName + "`.`" + tableName);
            ...
            _lst = new MySqlColumnList(cmd, tableName);
